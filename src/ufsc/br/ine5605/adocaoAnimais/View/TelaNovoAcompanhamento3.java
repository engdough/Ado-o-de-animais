...
public class TelaNovoAcompanhamento3 extends JFrame {
	private JLabel animalBemCuidado;
	...
	public TelaNovoAcompanhamento3 (ControladorAdocao controladorAdocao, ConteudoTelaAcompanhamento conteudoTelaAcompanhamento,ConteudoTelaFormularioAcompanhamento conteudoTelaFormularioAcompanhamento,int codigo) {
		super("Novo Acompanhamento");
		
		animalBemCuidado = new JLabel();
		botaoS = new JButton();
		botaoN = new JButton();
    	...
    	animalBemCuidado.setText("O animal esta bem cuidado?");
    	g.fill = GridBagConstraints.HORIZONTAL;
    	g.gridx = 0;
    	g.gridy = 0;
    	container.add(animalBemCuidado,g);
	...
	private class GerenciadorBotoes implements ActionListener{
		...
		public void actionPerformed(ActionEvent ae) {
			 if(ae.getSource() == botaoS) {
				 formulario.setAnimalLimpo(true);
				 setVisible(false);
				 new TelaNovoAcompanhamento4(controladorAdocao, conteudoTelaAcompanhamento, formulario, codigo);
				 return;
			 } else if (ae.getSource() == botaoN) {
				 formulario.setAnimalLimpo(false);
				 setVisible(false);
				 new TelaNovoAcompanhamento4(controladorAdocao, conteudoTelaAcompanhamento, formulario, codigo);
				 return;
			 }
