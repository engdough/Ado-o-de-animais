...
public class TelaNovoAcompanhamento5 extends JFrame {
	private JLabel animalFerido;
	...
	public TelaNovoAcompanhamento5 (ControladorAdocao controladorAdocao, ConteudoTelaAcompanhamento conteudoTelaAcompanhamento,ConteudoTelaFormularioAcompanhamento conteudoTelaFormularioAcompanhamento,int codigo) {
		super("Novo Acompanhamento");
		
		animalFerido = new JLabel();
		botaoS = new JButton();
		botaoN = new JButton();
    	...
    	animalFerido.setText("O animal esta ferido?");
    	g.fill = GridBagConstraints.HORIZONTAL;
    	g.gridx = 0;
    	g.gridy = 0;
    	container.add(animalFerido,g);
	...
	private class GerenciadorBotoes implements ActionListener{
		...
		public void actionPerformed(ActionEvent ae) {
			 if(ae.getSource() == botaoS) {
				 formulario.setAnimalFerido(true);
				 setVisible(false);
				 new TelaNovoAcompanhamento6(controladorAdocao, conteudoTelaAcompanhamento, formulario, codigo);
				 return;
			 } else if (ae.getSource() == botaoN) {
				 formulario.setAnimalFerido(false);
				 setVisible(false);
				 new TelaNovoAcompanhamento6(controladorAdocao, conteudoTelaAcompanhamento, formulario, codigo);
				 return;
			 }
