 ...
 */
public class TelaCadastroNaoEncontrado extends JFrame{
     private GerenciadorBotoes btManager;
     private JLabel lbMensagemConfirmacao;
     private JButton btContinuar;
     
     public TelaCadastroNaoEncontrado(){
    ...
    private void configuraTela() {
        ...
        lbMensagemConfirmacao = new JLabel("CADASTRO NAO ENCONTRADO!!");
     ...
     private class GerenciadorBotoes implements ActionListener {
        public void actionPerformed(ActionEvent ae) {    
            if (ae.getSource().equals(btContinuar)){
                    setVisible(false);
